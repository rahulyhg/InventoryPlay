...
public class Helper {
        ...
        try {
            ShapeDrawable.ShaderFactory sf = new ShapeDrawable.ShaderFactory() {
                ...
                public Shader resize(int width, int height) {
                    ...
                    return new LinearGradient(0, 0, 0, view.getHeight(),
                            new int[]{
    ...
    private void writeFile(Bitmap bitmap, String fileName) {
    ...
    public void setHeaderInfo(LinearLayout headerContainer, ArrayList<AsnResponse.HeaderInfo> headerInfo) {
        ...
        for (AsnResponse.HeaderInfo obj : headerInfo) {
            @SuppressLint("InflateParams") ViewGroup infoView = (ViewGroup) ((MainActivity) mContext).getLayoutInflater().inflate(R.layout.header_info, null, false);
        ...
        if (headerInfo.size() > maxVisible) {
            ...
            less.setGravity(Gravity.END | Gravity.CENTER_VERTICAL);
